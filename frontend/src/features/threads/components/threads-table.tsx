...
export function ThreadsTable({
  ...
  return (
    <div className='flex flex-1 flex-col overflow-hidden'>
      ...
      />
      <div className='relative mt-4 flex-1 overflow-auto rounded-lg border border-[var(--table-border)]'>
        <Table data-testid='threads-table' className='border-separate border-spacing-0 rounded-lg bg-[var(--table-background)]'>
