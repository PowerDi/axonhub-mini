    ...
    <SheetPortal>
      ...
      >
        ...
        <SheetPrimitive.Close
          data-hit-area
          className='text-muted-foreground hover:bg-muted hover:text-foreground absolute top-2 right-2 rounded-md p-1.5 transition-colors focus:outline-hidden disabled:pointer-events-none'
        >
