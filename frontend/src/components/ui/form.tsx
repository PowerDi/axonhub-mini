...
function FormDescription({ className, asChild, ...props }: React.ComponentProps<'p'> & { asChild?: boolean }) {
  const { formDescriptionId } = useFormField();
  const Comp = asChild ? Slot : 'p';

  return <Comp data-slot='form-description' id={formDescriptionId} className={cn('text-muted-foreground text-sm', className)} {...props} />;
}
